...
export default class tispListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the `sexprList`
	 * labeled alternative in `tispParser.s_expr`.
	 * @param ctx the parse tree
	 */
	enterSexprList?: (ctx: SexprListContext) => void;
	/**
	 * Exit a parse tree produced by the `sexprList`
	 * labeled alternative in `tispParser.s_expr`.
	 * @param ctx the parse tree
	 */
	exitSexprList?: (ctx: SexprListContext) => void;
	/**
	 * Enter a parse tree produced by the `sexprAtom`
	 * labeled alternative in `tispParser.s_expr`.
	 * @param ctx the parse tree
	 */
	enterSexprAtom?: (ctx: SexprAtomContext) => void;
	/**
	 * Exit a parse tree produced by the `sexprAtom`
	 * labeled alternative in `tispParser.s_expr`.
	 * @param ctx the parse tree
	 */
	exitSexprAtom?: (ctx: SexprAtomContext) => void;
	/**
